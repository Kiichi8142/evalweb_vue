<template>
    ...
    <div class="p-4 lg:p-8">
        <div class="max-w-7xl mx-auto rounded-md p-6 space-y-6">
            <div>
                <p class="font-semibold text-2xl text-gray-950">รหัสผ่าน</p>
                <p class="text-gray-600">แก้ไขรหัสผ่านของคุณ</p>
            </div>
            <div class="border" />
            <div class="space-y-2">
                <form @submit.prevent="handleSubmit" class="grid grid-cols-1 space-y-2">
                    <div class="flex flex-col">
                        ...
                        <input :class="{ 'border-2 border-red-600': errors.current_password && errors.current_password[0] }"
                            ...
                            class="rounded-md md:w-1/2 border px-4 py-1 border-gray-400">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input
                            ...
                            id="new-password-confirm" class="rounded-md md:w-1/2 border px-4 py-1 border-gray-400">
                    </div>
                    <button class="p-2 bg-blue-600 rounded-md text-gray-50 w-fit">Update</button>
                </form>
            </div>
        </div>
    </div>
